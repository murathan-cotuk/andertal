...
export default function SettingsPage() {
  ...
  const settingsItems = [
    ...
    { href: "/settings/payments", icon: CreditCardIcon, title: t("Payments & IBAN", "Odeme ve IBAN", "Paiements et IBAN", "Pagos e IBAN", "Pagamenti e IBAN", "Zahlungen & IBAN"), description: t("IBAN for payouts and saved card for shipping labels", "Odeme IBAN bilgisi ve kargo etiketi icin kayitli kart", "IBAN pour les versements et carte enregistree pour les etiquettes", "IBAN para pagos y tarjeta guardada para etiquetas", "IBAN per pagamenti e carta salvata per etichette", "IBAN fur Auszahlungen und hinterlegte Karte fur Versandetiketten") },
