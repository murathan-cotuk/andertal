...
const T = {
  en: {
    ...
    triggers: {
      ...
      seller_docs_submitted: "Seller submitted verification documents",
      seller_verification_approved: "Seller verification approved",
      seller_verification_rejected: "Seller verification rejected",
      seller_documents_required: "Seller: new documents required",
      ...
      favorite_price_drop: "Favorited product price drop",
      customer_message_sent: "Customer sent a message (copy to customer)",
      seller_new_customer_message: "Customer sent a message (notify seller)",
  ...
  de: {
    ...
    triggers: {
      ...
      seller_docs_submitted: "Verkäufer hat Verifizierungsdokumente eingereicht",
      seller_verification_approved: "Verkäufer-Verifizierung genehmigt",
      seller_verification_rejected: "Verkäufer-Verifizierung abgelehnt",
      seller_documents_required: "Verkäufer: neue Dokumente erforderlich",
      ...
      favorite_price_drop: "Merkliste-Produkt im Preis gesenkt",
      customer_message_sent: "Kunde hat Nachricht gesendet (Kopie an Kunde)",
      seller_new_customer_message: "Kunde hat Nachricht gesendet (Seller benachrichtigen)",
  ...
  tr: {
    ...
    triggers: {
      ...
      seller_docs_submitted: "Satıcı doğrulama evrakı gönderdi",
      seller_verification_approved: "Satıcı doğrulaması onaylandı",
      seller_verification_rejected: "Satıcı doğrulaması reddedildi",
      seller_documents_required: "Satıcı: yeni evrak gerekli",
      ...
      favorite_price_drop: "Favorilenen ürünün fiyatı düştü",
      customer_message_sent: "Müşteri mesaj gönderdi (müşteriye kopya)",
      seller_new_customer_message: "Müşteri mesaj gönderdi (satıcıya bildirim)",
  ...
  fr: {
    ...
    triggers: {
      ...
      seller_docs_submitted: "Le vendeur a soumis les documents de vérification",
      seller_verification_approved: "Vérification du vendeur approuvée",
      seller_verification_rejected: "Vérification du vendeur refusée",
      seller_documents_required: "Vendeur : nouveaux documents requis",
      ...
      favorite_price_drop: "Baisse de prix d'un produit favori",
      customer_message_sent: "Le client a envoyé un message (copie au client)",
      seller_new_customer_message: "Le client a envoyé un message (notifier le vendeur)",
  ...
  it: {
    ...
    triggers: {
      ...
      seller_docs_submitted: "Il venditore ha inviato i documenti di verifica",
      seller_verification_approved: "Verifica venditore approvata",
      seller_verification_rejected: "Verifica venditore rifiutata",
      seller_documents_required: "Venditore: nuovi documenti richiesti",
      ...
      favorite_price_drop: "Calo di prezzo su un prodotto preferito",
      customer_message_sent: "Il cliente ha inviato un messaggio (copia al cliente)",
      seller_new_customer_message: "Il cliente ha inviato un messaggio (notifica al seller)",
  ...
  es: {
    ...
    triggers: {
      ...
      seller_docs_submitted: "El vendedor envió documentos de verificación",
      seller_verification_approved: "Verificación de vendedor aprobada",
      seller_verification_rejected: "Verificación de vendedor rechazada",
      seller_documents_required: "Vendedor: se requieren nuevos documentos",
      ...
      favorite_price_drop: "Bajada de precio de un producto favorito",
      customer_message_sent: "El cliente envió un mensaje (copia al cliente)",
      seller_new_customer_message: "El cliente envió un mensaje (notificar al vendedor)",
