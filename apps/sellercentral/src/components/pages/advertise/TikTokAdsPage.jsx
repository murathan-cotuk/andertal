...
export default function TikTokAdsPage() {
  ...
  return (
    <Container>
      <Title>TikTok Ads Integration</Title>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
          <div>
            ...
            <p style={{ color: "#6b7280" }}>
              {isConnected ? "Your TikTok Ads account is connected" : "Connect your TikTok Ads account to manage campaigns"}
            </p>
          </div>
        ...
        {!isConnected ? (
          <div>
            <div style={{ marginBottom: "16px" }}>
              <Input
                label="TikTok Ads API Key"
                type="password"
                value={apiKey}
                onChange={(e) => setApiKey(e.target.value)}
                placeholder="Enter your TikTok Ads API key"
              />
            </div>
