  ...
  const items = [
    ...
    },
    {
      ...
      subNavigationItems: [
        ...
        { url: "/customers/back-in-stock", label: tx("backInStock", "Back in stock"), superuserOnly: true },
      ],
    },
  ];
  ...
  items.push(
    {
      ...
      subNavigationItems: [
        ...
        { url: "/marketing/affiliate", label: tx("affiliateMarketing", "Affiliate"), superuserOnly: true },
