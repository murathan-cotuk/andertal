...
import { flattenCategoryIndex, paintCategoryWorkbook } from "@/lib/category-excel";
  ...
  try {
    ...
    return new Response(buf, {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="${categoryExcelFilename("template", locale)}"`,
        "Cache-Control": "no-cache",
      },
    });
  } catch (e) {
    console.error("category template:", e);
