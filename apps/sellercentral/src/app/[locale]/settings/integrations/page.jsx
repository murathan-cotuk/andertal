...
function documentSourcesCopy(locale) {
  ...
  return {
    ...
    intro: t(
      "By default Andertal generates these documents. Delivery notes and return labels can come from your ERP instead. Invoices sent to the customer and to you are always Andertal’s (they include bonus points and the payment split) — your own invoice can still be uploaded for your records.",
      "Varsayılan olarak bu belgeleri Andertal oluşturur. İrsaliye ve iade etiketi ERP’nizden gelebilir. Müşteriye ve size gönderilen faturalar her zaman Andertal faturasıdır (bonus puan ve ödeme ayrımı burada görünür); kendi faturanızı kayıtlarınız için yine yükleyebilirsiniz.",
      "Par défaut, Andertal génère ces documents. Bons de livraison et étiquettes de retour peuvent venir de votre ERP. Les factures envoyées au client et à vous sont toujours celles d’Andertal (points bonus et répartition du paiement) — vous pouvez toujours déposer la vôtre pour vos archives.",
      "Por defecto Andertal genera estos documentos. Albaranes y etiquetas de devolución pueden venir de tu ERP. Las facturas enviadas al cliente y a ti son siempre las de Andertal (puntos bonus y desglose de pago); puedes subir la tuya para tu archivo.",
      "Per impostazione predefinita Andertal genera questi documenti. Bolle ed etichette di reso possono arrivare dal tuo ERP. Le fatture inviate a cliente e venditore sono sempre quelle di Andertal (punti bonus e ripartizione del pagamento); puoi comunque caricare la tua per l’archivio.",
      "Standardmäßig erstellt Andertal diese Dokumente. Lieferscheine und Retourenetiketten können aus deinem ERP kommen. Rechnungen an Kunde und Verkäufer sind immer Andertal-Rechnungen (Bonuspunkte und Zahlungsaufteilung) — deine eigene Rechnung kannst du weiterhin für deine Unterlagen hinterlegen.",
    ),
