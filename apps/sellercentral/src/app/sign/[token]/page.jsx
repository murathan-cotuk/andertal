...
const CONTRACT_SECTIONS = {
  de: [
    { heading: "Praeambel", body: 'Diese Vereinbarung regelt die Rechtsbeziehung zwischen dem Betreiber der Plattform Andertal (nachfolgend "Plattform") und dem registrierten Verkaeufer (nachfolgend "Verkaeufer"). Mit Abschluss der Verifizierung erklaert sich der Verkaeufer mit allen nachfolgenden Bedingungen einverstanden.' },
    { heading: "SS 1 - Vertragsgegenstand", body: 'Die Plattform stellt dem Verkaeufer eine technische Infrastruktur zum Anbieten, Verwalten und Verkaufen von Waren gegenueber Endverbrauchern zur Verfuegung. Der Verkaeufer tritt als eigenverantwortlicher Haendler im eigenen Namen und auf eigene Rechnung auf.' },
    { heading: "SS 2 - Pflichten des Verkaefers", body: 'Der Verkaeufer verpflichtet sich:\n- Ausschliesslich legale Waren anzubieten und geltende Vorschriften einzuhalten.\n- Vollstaendige und korrekte Geschaeftsdaten bereitzustellen und aktuell zu halten.\n- Bestellungen innerhalb der angegebenen Lieferfristen zu erfuellen.\n- Gesetzliche Gewaehrleistungsrechte und 14-taegiges Widerrufsrecht zu beachten.\n- Keine Preisabsprachen oder unlauteren Wettbewerb zu betreiben.' },
    { heading: "SS 3 - Datenschutz (DSGVO)", body: 'Der Verkaeufer verarbeitet personenbezogene Daten von Endkunden ausschliesslich zur Vertragserfuellung. Eine Weitergabe an Dritte ohne Rechtsgrundlage ist untersagt. Betroffenenanfragen sind innerhalb von 30 Tagen zu beantworten.' },
    { heading: "SS 4 - Provisionen und Zahlungsbedingungen", body: 'Die Plattform erhebt eine Transaktionsgebuehr gemaess der zum Zeitpunkt des Verkaufs gueltigen Preisliste. Auszahlungen erfolgen nach Auftragsabschluss und Ablauf der Rueckgabefrist. Bei Verzug werden Verzugszinsen gemaess SS 288 BGB faellig.' },
    { heading: "SS 5 - Ranking und Sichtbarkeit", body: 'Gemaess EU-Verordnung 2019/1150 informiert die Plattform ueber die wesentlichen Ranking-Parameter: Produktqualitaet, Kundenbewertungen, Bestellabwicklungsrate, Preisgestaltung und Konto-Compliance.' },
    { heading: "SS 6 - Kontosperrung und Kuendigung", body: 'Die Plattform kann das Konto bei schwerwiegenden Verstoessen sperren oder kuendigen. Dem Verkaeufer wird, sofern moeglich, eine Frist zur Stellungnahme eingeraeumt. Der Verkaeufer kann jederzeit mit 30 Tagen Frist kuendigen.' },
    { heading: "SS 7 - Haftungsbeschraenkung", body: 'Die Plattform haftet nicht fuer Schaeden durch fehlerhafte Produktangaben des Verkaefers, Lieferverzoegerungen oder Produktmaengel. Die Haftung fuer mittelbare Schaeden ist - ausser bei Vorsatz - ausgeschlossen.' },
    { heading: "SS 8 - Streitbeilegung", body: 'Streitigkeiten werden zunaechst intern ueber support@andertal.com behandelt. Als externe Stelle steht das EU-ODR-Portal (https://ec.europa.eu/consumers/odr/) zur Verfuegung. Es gilt deutsches Recht, Gerichtsstand Berlin.' },
    { heading: "SS 9 - Schlussbestimmungen", body: 'Aenderungen werden mindestens 15 Tage vor Inkrafttreten per E-Mail mitgeteilt. Sollten einzelne Bestimmungen unwirksam sein, bleiben die uebrigen wirksam. Letzte Aktualisierung: April 2026.' },
  ],
  tr: [
    { heading: "Onsoz", body: 'Bu sozlesme, Andertal platformunun isletmecisi ("Platform") ile kayitli satici ("Satici") arasindaki hukuki iliskiyi duzenler.' },
    { heading: "Madde 1 - Konu", body: "Platform, Saticiya urun sunma, yonetme ve satma amacıyla teknik altyapi saglar. Satici bagimsiz bir tacir olarak hareket eder." },
    { heading: "Madde 2 - Satici Yukumlulukler", body: "Satici;\n- Yalnizca yasal urunler sunmayi,\n- Dogru ticari bilgiler saglamayi,\n- Siparisleri zamaninda yerine getirmeyi,\n- Yasal garanti ve cayma haklarina uymay,\n- Haksiz rekabetten kacınmayi taahhut eder." },
    { heading: "Madde 3 - Kisisel Veriler (KVKK/GDPR)", body: "Satici, musteri verilerini yalnizca sozlesmenin ifasi icin isler. Hukuki dayanak olmaksizin veri aktarimi yasaktir. Veri sahibi talepleri 30 gun icinde yanitlanmalidir." },
    { heading: "Madde 4 - Komisyon ve Odeme", body: "Platform, gecerli fiyat listesine gore islem ucreti alir. Odemeler siparis tamamlanip iade suresi dolduktan sonra yapilir." },
    { heading: "Madde 5 - Siralama", body: "P2B Tuzugu kapsaminda Platform siralama parametrelerini aciklar: urun kalitesi, degerlendirmeler, teslimat orani ve hesap uyumlulugu." },
    { heading: "Madde 6 - Askiya Alma ve Fesih", body: "Platform agir ihlallerde hesabi askiya alabilir. Satici 30 gun onceden bildirerek feshedebilir." },
    { heading: "Madde 7 - Sorumluluk", body: "Platform, Satici kaynakli zararlardan sorumlu degildir. Dolayli zararlar icin sorumluluk sinirlidir." },
    { heading: "Madde 8 - Uyusmazlik", body: "Uyusmazliklar once support@andertal.com uzerinden cozulur. Yetkili mahkeme Berlin'dir." },
    { heading: "Madde 9 - Son Hukumler", body: "Degisiklikler en az 15 gun once bildirilir. Son guncelleme: Nisan 2026." },
  ],
  en: [
