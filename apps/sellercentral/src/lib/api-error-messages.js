...
const MESSAGE_MAP = {
  ...
  "an account with this email already exists": {
    ...
    tr: "Bu e-posta ile zaten bir hesap var. Bunun yerine giriş yapmayı deneyin.",
    fr: "Un compte avec cet e-mail existe déjà. Essayez de vous connecter à la place.",
    es: "Ya existe una cuenta con este correo. Intenta iniciar sesión.",
    it: "Esiste già un account con questa e-mail. Prova ad accedere invece.",
    de: "Ein Konto mit dieser E-Mail-Adresse existiert bereits. Bitte stattdessen anmelden.",
  },
