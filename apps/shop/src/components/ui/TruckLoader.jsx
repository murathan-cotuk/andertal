...
const TruckBodyAnim = styled.div`
  width: 130px;
  height: fit-content;
  margin-bottom: 6px;
...
/** Shared truck-on-a-road loading animation — used across checkout submission and the
 * post-checkout order pages so the "your order is on its way" moment reads as one
 * continuous animation instead of switching to a generic spinner mid-flow. */
export default function TruckLoader({ label }) {
  return (
    <ProcessingOverlay>
      <div style={{ width: "fit-content", height: "fit-content", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <TruckWrap>
          ...
          <TruckRoad />
          <LampPost viewBox="0 0 453.459 453.459" xmlns="http://www.w3.org/2000/svg" fill="#000000">
