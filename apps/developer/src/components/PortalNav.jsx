...
export default function PortalNav() {
  ...
  return (
    <nav style={S.nav}>
      <a href={`/${locale}/dashboard`} style={S.brand}>Andertal <span style={{ color: '#555', fontWeight: 400 }}>Developers</span></a>
      <div style={S.sep} />
      <a href={`/${locale}/dashboard`} style={S.link(isActive('dashboard'))}>{t('dashboard')}</a>
      <a href={`/${locale}/apps`} style={S.link(isActive('/apps'))}>{t('apps')}</a>
      <div style={S.spacer} />
