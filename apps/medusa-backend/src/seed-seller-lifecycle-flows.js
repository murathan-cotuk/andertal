...
<p style="margin:0 0 16px;">Dear {STORE_NAME} team,</p>
...
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">Questions? Just reply to this email or reach us at {SUPPORT_EMAIL}.</p>`),
      ...
      tr: {
        ...
        body: shell(ACCENTS.seller_signup, `
<p style="margin:0 0 16px;">Sayın {STORE_NAME} Ekibi,</p>
...
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">Sorularınız için bu e-postayı yanıtlayabilir veya {SUPPORT_EMAIL} adresine yazabilirsiniz.</p>`),
      ...
      fr: {
        ...
        body: shell(ACCENTS.seller_signup, `
<p style="margin:0 0 16px;">Chère équipe {STORE_NAME},</p>
...
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">Des questions ? Répondez simplement à cet e-mail ou écrivez-nous à {SUPPORT_EMAIL}.</p>`),
      ...
      it: {
        ...
        body: shell(ACCENTS.seller_signup, `
<p style="margin:0 0 16px;">Gentile team di {STORE_NAME},</p>
<p style="margin:0 0 16px;">Grazie per aver registrato <strong>{STORE_NAME}</strong> su {PLATFORM_NAME}! Il Vostro account è stato creato ed è già possibile accedere al Seller Central.</p>
<p style="margin:0 0 16px;">Prima di poter vendere, è necessario verificare la Vostra attività. Ecco i prossimi passi:</p>
<ol style="margin:0 0 16px;padding-left:20px;">
<li style="margin-bottom:6px;">Accedere al Seller Central</li>
<li style="margin-bottom:6px;">Completare il profilo aziendale (P.IVA, codice fiscale, indirizzo)</li>
<li style="margin-bottom:6px;">Caricare i documenti di verifica richiesti</li>
<li>Esamineremo la Vostra richiesta e Vi risponderemo entro 1-2 giorni lavorativi</li>
</ol>
${cta(ACCENTS.seller_signup, '{SELLERCENTRAL_LOGIN_URL}', 'Completa la verifica')}
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">Domande? Rispondete a questa email oppure scrivete a {SUPPORT_EMAIL}.</p>`),
      },
      es: {
        subject: 'Bienvenido a {PLATFORM_NAME} Seller Central — empecemos la verificación',
        body: shell(ACCENTS.seller_signup, `
<p style="margin:0 0 16px;">Estimado equipo de {STORE_NAME},</p>
...
<p style="margin:0 0 16px;">Antes de poder vender, necesitamos verificar su negocio. Estos son los próximos pasos:</p>
<ol style="margin:0 0 16px;padding-left:20px;">
<li style="margin-bottom:6px;">Iniciar sesión en Seller Central</li>
<li style="margin-bottom:6px;">Completar su perfil de empresa (NIF, IVA, dirección fiscal)</li>
<li style="margin-bottom:6px;">Subir los documentos de verificación requeridos</li>
<li>Revisaremos su solicitud y les responderemos en 1-2 días hábiles</li>
</ol>
${cta(ACCENTS.seller_signup, '{SELLERCENTRAL_LOGIN_URL}', 'Completar verificación')}
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">¿Dudas? Responda a este correo o escríbanos a {SUPPORT_EMAIL}.</p>`),
      },
      de: {
        subject: 'Willkommen bei {PLATFORM_NAME} Seller Central — jetzt verifizieren',
        body: shell(ACCENTS.seller_signup, `
<p style="margin:0 0 16px;">Sehr geehrtes {STORE_NAME}-Team,</p>
...
<p style="margin:0 0 16px;">Di solito richiede <strong>1-2 giorni lavorativi</strong>. Riceverete un'email non appena verrà presa una decisione — al momento non è richiesta nessuna azione da parte Vostra.</p>
<p style="margin:0 0 16px;">È possibile controllare lo stato in qualsiasi momento nel Seller Central, alla voce "Verifica".</p>
${cta(ACCENTS.seller_docs_submitted, '{SELLERCENTRAL_LOGIN_URL}', 'Visualizza stato verifica')}
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">Domande nel frattempo? Scriveteci a {SUPPORT_EMAIL}.</p>`),
      },
      es: {
        subject: 'Hemos recibido sus documentos — verificación en curso',
        body: shell(ACCENTS.seller_docs_submitted, `
<p style="margin:0 0 16px;">Estimado equipo de {STORE_NAME},</p>
...
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">¿Dudas mientras tanto? Escríbanos a {SUPPORT_EMAIL}.</p>`),
      },
      de: {
...
<p style="margin:0 0 16px;">Dear {STORE_NAME} team,</p>
<p style="margin:0 0 16px;text-align:center;font-size:18px;font-weight:700;color:#16a34a;">Congratulations!</p>
...
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">Need help getting started? We're at {SUPPORT_EMAIL}.</p>`),
      ...
      tr: {
        ...
        body: shell(ACCENTS.seller_verification_approved, `
<p style="margin:0 0 16px;">Sayın {STORE_NAME} Ekibi,</p>
<p style="margin:0 0 16px;text-align:center;font-size:18px;font-weight:700;color:#16a34a;">Tebrikler!</p>
...
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">Başlarken yardıma mı ihtiyacınız var? {SUPPORT_EMAIL} adresinden bize ulaşın.</p>`),
      ...
      fr: {
        ...
        body: shell(ACCENTS.seller_verification_approved, `
<p style="margin:0 0 16px;">Chère équipe {STORE_NAME},</p>
<p style="margin:0 0 16px;text-align:center;font-size:18px;font-weight:700;color:#16a34a;">Félicitations !</p>
...
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">Besoin d'aide pour démarrer ? Écrivez-nous à {SUPPORT_EMAIL}.</p>`),
      ...
      it: {
        ...
        body: shell(ACCENTS.seller_verification_approved, `
<p style="margin:0 0 16px;">Gentile team di {STORE_NAME},</p>
<p style="margin:0 0 16px;text-align:center;font-size:18px;font-weight:700;color:#16a34a;">Congratulazioni!</p>
<p style="margin:0 0 16px;"><strong>{STORE_NAME}</strong> è stato verificato e approvato. Da ora è possibile aggiungere prodotti e iniziare a vendere su {PLATFORM_NAME}.</p>
<p style="margin:0 0 16px;">Alcuni consigli per iniziare al meglio:</p>
<ul style="margin:0 0 16px;padding-left:20px;">
<li style="margin-bottom:6px;">Aggiungere i primi prodotti con foto chiare e descrizioni complete</li>
<li style="margin-bottom:6px;">Impostare prezzi competitivi e livelli di stock accurati</li>
<li style="margin-bottom:6px;">Mantenere aggiornati i tempi di spedizione per evitare ritardi</li>
</ul>
${cta(ACCENTS.seller_verification_approved, '{SELLERCENTRAL_LOGIN_URL}', 'Vai a Seller Central')}
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">Serve assistenza per iniziare? Ci contatti a {SUPPORT_EMAIL}.</p>`),
      },
      es: {
        subject: '¡Has sido aprobado! Empieza a vender en {PLATFORM_NAME}',
        body: shell(ACCENTS.seller_verification_approved, `
<p style="margin:0 0 16px;">Estimado equipo de {STORE_NAME},</p>
<p style="margin:0 0 16px;text-align:center;font-size:18px;font-weight:700;color:#16a34a;">¡Enhorabuena!</p>
<p style="margin:0 0 16px;"><strong>{STORE_NAME}</strong> ha sido verificado y aprobado. Ya pueden añadir productos y empezar a vender en {PLATFORM_NAME}.</p>
<p style="margin:0 0 16px;">Algunos consejos para empezar con fuerza:</p>
<ul style="margin:0 0 16px;padding-left:20px;">
<li style="margin-bottom:6px;">Añadir los primeros productos con fotos claras y descripciones completas</li>
<li style="margin-bottom:6px;">Definir precios competitivos y niveles de stock precisos</li>
<li style="margin-bottom:6px;">Mantener los plazos de envío actualizados para evitar retrasos</li>
</ul>
${cta(ACCENTS.seller_verification_approved, '{SELLERCENTRAL_LOGIN_URL}', 'Ir a Seller Central')}
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">¿Necesitan ayuda para empezar? Contáctenos en {SUPPORT_EMAIL}.</p>`),
      },
      de: {
        subject: 'Sie wurden freigeschaltet! Jetzt bei {PLATFORM_NAME} verkaufen',
        body: shell(ACCENTS.seller_verification_approved, `
<p style="margin:0 0 16px;">Sehr geehrtes {STORE_NAME}-Team,</p>
<p style="margin:0 0 16px;text-align:center;font-size:18px;font-weight:700;color:#16a34a;">Herzlichen Glückwunsch!</p>
...
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">Des questions sur cette décision ? Contactez-nous à {SUPPORT_EMAIL}.</p>`),
      ...
      it: {
        subject: 'Aggiornamento sulla Vostra candidatura come venditore {PLATFORM_NAME}',
        body: shell(ACCENTS.seller_verification_rejected, `
<p style="margin:0 0 16px;">Gentile team di {STORE_NAME},</p>
<p style="margin:0 0 16px;">Grazie per aver richiesto di vendere su {PLATFORM_NAME} con <strong>{STORE_NAME}</strong>. Dopo aver esaminato la Vostra richiesta, al momento non possiamo approvare il Vostro account venditore.</p>
<div style="background:#fef2f2;border:1px solid #fecaca;border-radius:8px;padding:14px 16px;margin:0 0 16px;">
<p style="margin:0;font-size:13px;color:#7f1d1d;"><strong>Motivo:</strong> {REJECTION_REASON}</p>
</div>
<p style="margin:0 0 16px;">Se ritenete che si tratti di un errore, o se potete risolvere il problema sopra indicato, potete aggiornare il Vostro profilo e i documenti in Seller Central e rivaluteremo la Vostra richiesta.</p>
...
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">Domande su questa decisione? Contattaci a {SUPPORT_EMAIL}.</p>`),
      ...
      es: {
        subject: 'Actualización sobre su solicitud de vendedor en {PLATFORM_NAME}',
        body: shell(ACCENTS.seller_verification_rejected, `
<p style="margin:0 0 16px;">Estimado equipo de {STORE_NAME},</p>
<p style="margin:0 0 16px;">Gracias por solicitar vender en {PLATFORM_NAME} con <strong>{STORE_NAME}</strong>. Tras revisar su solicitud, no podemos aprobar su cuenta de vendedor en este momento.</p>
<div style="background:#fef2f2;border:1px solid #fecaca;border-radius:8px;padding:14px 16px;margin:0 0 16px;">
<p style="margin:0;font-size:13px;color:#7f1d1d;"><strong>Motivo:</strong> {REJECTION_REASON}</p>
</div>
<p style="margin:0 0 16px;">Si consideran que se trata de un error, o si pueden resolver lo indicado arriba, pueden actualizar su perfil y documentos en Seller Central y volveremos a revisar su solicitud.</p>
...
<p style="margin:0 0 16px;">Vi chiediamo di caricare il/i documento/i richiesto/i in Seller Central il prima possibile, così da proseguire la revisione senza ritardi.</p>
${cta(ACCENTS.seller_documents_required, '{SELLERCENTRAL_LOGIN_URL}', 'Carica documenti')}
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">Non siete sicuri di cosa sia necessario? Scriveteci a {SUPPORT_EMAIL} e Vi aiuteremo.</p>`),
      },
      es: {
...
<p style="margin:20px 0 0;font-size:13px;color:#6b7280;">¿No están seguros de qué se necesita? Escríbanos a {SUPPORT_EMAIL}.</p>`),
      },
      de: {
